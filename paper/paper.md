...
More compute can be brought to bear by combining [EOSC](https://eosc.eu/), [ELIXIR](https://elixir-europe.org/) and the de.NBI Cloud [@citesAsAuthority:10.12688/f1000research.19013.1] infrastructures, [Galaxy](https://galaxyproject.org/) instances, and existing resources like [EMBL-EBI’s MGnify](https://www.ebi.ac.uk/metagenomics) [@citesAsAuthority:Richardson2023-ot] or the [Cloud-based Workflow Manager (CloWM)](https://github.com/metagenomics/metagenomics-tk), but this requires adopting a common schema for sharing analysed datasets, including their provenance. 
