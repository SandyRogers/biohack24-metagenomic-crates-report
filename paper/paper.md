...
Tooling also exists to aid in rendering a pipeline specification or codebase as a crate: for example the [release of nf-core/tools 3.1.0](https://nf-co.re/blog/2024/tools-3_1_0) adds a feature to render an RO-Crate description of an nf-core compatible pipeline by running the command `nf-core pipelines rocrate`, with metadata like authorship controlled by a config file manifest.
